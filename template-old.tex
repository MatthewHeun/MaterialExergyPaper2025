...
% \caption{Efficiency Methods. If there are multiple panels, they should be listed as: (\textbf{a}) Description of what is contained in the first panel. (\textbf{b}) Description of what is contained in the second panel. Figures should be placed in the main text near to the first time they are cited. A caption on a single line should be centered.\label{fig1}}
% \end{figure}
% \unskip
%
% \begin{table}[H]
...
% $b_{c}$             & molar intensive concentration exergy [kJ/mol] \\
% $b_{ch}$            & molar intensive chemical exergy [kJ/mol] \\
% $B_{m}$             & total material exergy for a mixture [kJ]\\
% $b_m$               & molar intensive material exergy [kJ/mol] \\
