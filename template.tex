...
\corres{Correspondence: email: mkh2@calvin.ed; Tel.: +1 (616) 526-6663}
...
from each stage of a process relative 
to the equilibrium state of the reference environment 
defined by $T_{0}$, $P_{0}$, and a certain chemical composition.
Thus, the total exergy is the sum of the work
of the reversible proces that brings the system at 
a given temperature and pressure to $T_{0}$ and $P_{0}$
(without changes in the chemical composition), 
or the thermomechanical exergy, $b_{th}$.
It also includes the chemical exergy, $b_{ch}$, 
the work needed to take the substance from its composition
to the chemical composition of the same substance in the reference environment.

Reference environments include the Atmosphere, 
the Ocean, and the Earth's crust.
...
$T_{0}$ and $P_{0}$.
Thus, thermomechanical exergy is zero
...
Material exergy of a natural resource
...
The first component of material exergy
is the distribution exergy
of the natural resource ($b_{d}$),
while the second is the sum
of the chemical exergies of 
each compound present 
in the mixture ($b_{ch}$).
...
in the mix ($n$) for each species. %j is element in the compound, i is the compound
