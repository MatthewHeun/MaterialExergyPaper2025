...
1. Showing a consistent material exergy analysis approach 
for material conversion chains.
2. Apply the anaylses process 
from the iron ore 
to blast furnace material conversion chain.
3. Demonstrate the interaction between energy 
and material conversion chains 
using the PSUT matrix structure.
