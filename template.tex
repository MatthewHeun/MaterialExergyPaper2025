...
\replaced[id=MKH]{Thus, the total exergy of a system
...
of the reversible proces that
brings the system at $T, P$ to $T_{0}$,$P_{0}$
...
Reference environments \added[id=MKH]{can} include the Atmosphere,
the Ocean, or the Earth's crust.
\added[id=MKH]{For our purposes,}
\replaced[id=MKH]{the}{The}
reference environments are at $T_{0}$ and $P_{0}$, and are
...
**** I think we need $y_i$ instead of $x_i$
for mole fractions.
Am I right? ---MKH ****}
{% Not this
...
% begin take out of the following paragraphs
...
>>>>>>> 3161eeb548b5de973bfd531069fc51ba316cd4b1
