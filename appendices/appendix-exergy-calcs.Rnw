...
\begin{equation}\label{b_ch_CaCO3}
  \Sexpr{b_ch_CaCO3}[kJ/mol] = \Sexpr{deltaG_CaCO3}[kJ/mol] + ((1 [\frac{mol \ce{Ca}}{mol \ce{CaCO3}}]\cdot~\Sexpr{b_ch_Ca}[kJ/mol])+(1[\frac{mol \ce{C}}{mol \ce{CaCO3}}]\cdot~\Sexpr{b_ch_C}[kJ/mol])
  +(\frac{3}{2}[\frac{mol \ce{O2}}{mol \ce{CaCO3}}]\cdot~\Sexpr{b_ch_O2}[kJ/mol])) \, .
\end{equation}
...
\begin{equation}\label{b_c_CaCO3}
  \Sexpr{b_c_CaCO3} [kJ/mol] = \Sexpr{RT0}[kJ/mol] \cdot~\ln(\Sexpr{y_CaCO3}[mol \ce{CaCO3}/ mol_{limestone}]) \, .
\end{equation}
