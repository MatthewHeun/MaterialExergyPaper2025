...
contain exergy values in MJ.
Rows and columns are removed if all values are 0.
Entries of 0.0 indicate non-zero values that round to 0.0~MJ.
See the Supplemental Information for an Excel file
...
print_named_matrix(matrix_name = "R__MCC_B_RUVY_matrices_mat_level",
...
print_named_matrix(matrix_name = "V__MCC_B_RUVY_matrices_mat_level",
...
print_named_matrix(matrix_name = "Y__MCC_B_RUVY_matrices_mat_level",
...
print_named_matrix(matrix_name = "R__ZAF_2013_X",
                   latex_label = "fig:rx_example_mat",
                   bgcolor = "RYbgcolor",
                   file = file.path("data", "ecc_supply_to_mcc.xlsx"),
                   digits = 1,
                   factor = factor_for_cc_matvals,
                   caption = paste0("Resource ($\\mat{R}$) matrix for ",
...
print_named_matrix(matrix_name = "U__ZAF_2013_X",
...
print_named_matrix(matrix_name = "V__ZAF_2013_X",
...
print_named_matrix(matrix_name = "Y__ZAF_2013_X",
