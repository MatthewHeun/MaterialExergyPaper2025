...
print_named_matrix(matrix_name = "R__B",
                   ...
                   caption = "Resource ($\\mat{R}$) matrix for the example material conversion chain (BCC). All values are exergies in MJ.",
                   size = "tiny")
@
...
print_named_matrix(matrix_name = "U__B",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Use ($\\mat{U}$) matrix for the example material conversion chain (BCC). All values are exergies in MJ.",
                   size = "tiny")
@
...
print_named_matrix(matrix_name = "V__B",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Make ($\\mat{V}$) matrix for the example material conversion chain (BCC). All values are exergies in MJ.",
                   size = "tiny")
@
\end{landscape}
...
print_named_matrix(matrix_name = "Y__B",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Final demand ($\\mat{Y}$) matrix for the example material conversion chain (BCC). All values are exergies in MJ.",
                   size = "tiny")
@
...
print_named_matrix(matrix_name = "R__X",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Resource ($\\mat{R}$) matrix for the example energy conversion chain (XCC). All values are exergies in MJ.",
                   size = "tiny")
@
...
print_named_matrix(matrix_name = "U__X",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Use ($\\mat{U}$) matrix for the example energy conversion chain (XCC). All values are exergies in MJ.",
                   size = "tiny")
@
...
print_named_matrix(matrix_name = "V__X",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Make ($\\mat{V}$) matrix for the example energy conversion chain (XCC). All values are exergies in MJ.",
                   size = "tiny")
@
...
print_named_matrix(matrix_name = "Y__X",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Final demand ($\\mat{Y}$) matrix for the example energy conversion chain (XCC). All values are exergies in MJ.",
                   size = "tiny")
@
...
print_named_matrix(matrix_name = "R__BX",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Resource ($\\mat{R}$) matrix for the example unified material and energy conversion chain (BXCC). All values are exergies in MJ.",
                   size = "tiny")
@
...
print_named_matrix(matrix_name = "U__BX",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Use ($\\mat{U}$) matrix for the example unified material and energy conversion chain (BXCC). All values are exergies in MJ.",
                   size = "tiny")
@
\end{landscape}
...
print_named_matrix(matrix_name = "V__BX",
                   ...
                   digits = 1,
                   factor = 0.001, # Convert from kJ to MJ
                   caption = "Make ($\\mat{V}$) matrix for the example unified material and energy conversion chain (BXCC). All values are exergies in MJ.",
                   size = "tiny")
@
\end{landscape}
