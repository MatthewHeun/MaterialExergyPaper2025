...
%The number of moles in a mixture is determined by the mass composition of the stream and each components molecular weight which come from Fisher Scientific ~citep{Fisher 2025}.
...
% from Table 9.1 in Valero and Valero. ~\citep{Valero 2015}
...
%\delta{G_{f}}$ values come from ~\citep{Dean 1979} and ~\citep{***webpage of Thermochemical Values***}.
...
% The following two equations are in reference to ~\citet{Valero 2015}.
...
%Phi constants and examples for certain fuels come from ~\citep{Kotas 1995}.
...
%(~\citep{Energy and Environmental Profile of the U.S. 2025}) and ~\citep{Energy Research Institute, University CapeTown 2002}.
%Additional energy information comes from ~\citep{Jamison 2015}.
...
%Coal production compositions and energy inputs come from ~\citep{Matsuhashi 2012}, ~\citep{Zhang 2019}, ~\citep{Kotas 1995}, and various webpages.
%Limestone production compositions and energy inputs come from ~\citet{Saidur 2011}, ~\citet{Eriksson 2014}, and ~\citep{Satyendra 2013}.
