...
in specialized sectors of the economy.
Physical Supply Use Tables (PSUTs) matrices
show which products, industries, and sectors
materials and energy interact with.
Converting material and energy conversion chains to an exergy conversion chain allows us
to create exergy PSUT matrices.
...
applied to energy and material conversion chains in this paper.
The main four matrices the material and energy conversion chains are applied to
are the Resources, Make, Use, and Final demand matrices.
