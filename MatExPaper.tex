...
from Table 9.1 in Valero and Valero. ~\citep{Valero_2015}
...
$\delta{G_{f}}$ values come from ~\citep{Dean 1979} and ~\citep{Gibbs_formation}.
...
Coal production compositions and energy inputs come from ~\citep{Matsuhashi_2012}, ~\citep{Zhang_2019}, ~\citep{Kotas_1995}, and various webpages.
Limestone production compositions and energy inputs come from ~\citet{Saidur_2011}, ~\citet{Eriksson_2014}, and ~\citep{Satyendra_2013}.
