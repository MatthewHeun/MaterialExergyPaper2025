...
print_named_matrix <- function(matrix_name,
  ...
  # rotated_colnames <- c(paste0("\\rotatebox[origin=b]{90}{", colnames(mat_df), "}"))
  # rotated_colnames <- paste0("\\makebox[3em][c]{\\rotatebox[origin=b]{90}{", colnames(mat_df), "}}")
  # rotated_colnames <- paste0("\\rotatebox[origin=b]{90}{\\parbox[t]{2cm}{\\centering ", colnames(mat_df), "}}")
  # rotated_colnames <- paste0("\\rotatebox[origin=b]{90}{\\makebox[0pt][c]{", colnames(mat_df), "}}")
  ...
  # Rotate the column names
  # colnames(xt) <- rotated_colnames
  # Set alignment of rownames (r) and numbers in the matrix (c)
  xt_align <- paste0("r", paste(rep("c", times = ncol(mat_df)-1), collapse = ""))
