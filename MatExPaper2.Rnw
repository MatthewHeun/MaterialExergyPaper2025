...
****
Erin:
Note this is the appropriate way to narrate equations.
****
...
****
Erin:
Note this is \emph{not} the way to narrate equations.
****
...
and log of the fraction of moles per species ($y_i \ln y_i$).
...
The second component is the sum of concentration exergies of each compound
present in the mixture, $b_{c,i,1}$.
...
The total energy exergy **** suggestion: exergy of energy ---MKH **** ($X$)
of a process **** processes don't have exergy. statepoints do. ---MKH ****
