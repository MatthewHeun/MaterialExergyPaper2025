...
% \end{equation}
%
% where $R$ is the negative gas constant,
...
The following two equations are in reference to \citet{Valero_2015}.
...
Equation~(\ref{eq:specific_concentration_exergy_of_current_statepoint_definition}) becomes
