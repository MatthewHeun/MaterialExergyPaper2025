...
\end{equation}
%
where $\phi$ is the exergy to energy ratio,
$E_i$ is the energy of species $i$,
e.g.\ natural gas.
...
We obtain $\phi$ values from \citet{Kotas_1995}.
...
Various efficiencies are calculated
for a material conversion chain
depending on what information is desired.
